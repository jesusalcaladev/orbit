...
pnpm test            # 500 tests, Vitest (386 core + 14 express + 13 hono + 16 rest + 4 cache + 26 cloudflare-workers + 8 rate-limit + 12 auth + 5 logging + 8 redis + 8 kv-cache)
